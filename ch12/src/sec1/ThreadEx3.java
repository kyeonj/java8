...
//어떤 메모리에도 CUP가 찾는 데이터가 없을 수도 있는 현상이 발생하게 된다. -> 쓰레싱(Thrashing)
//갑자기 예기치 않은 상황이 발생할 경우 CPU는 하던 일을 멈추고, 긴급 상황을 처리하고 난 후 원래대로 복귀한다-> 인터럽스(Interrupted)
