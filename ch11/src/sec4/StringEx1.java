...
public class StringEx1 {
	...
	public static void main(String[] args) {
		...
		byte[] char1=str1.getBytes();	//문자열을 한 글짜식 바이트 단위로 분리
		System.out.println("char1은 문자열을 한 글자씩 분리 : ");
		charPrint(char1);
		int a=(char) str1.indexOf("i"); //해당문자를 찾기
		System.out.println("G는 몇번째? " +a); //중복이 될 경우 가장 먼저 찾은 문자와 위치
		...
		int b = 1004;
		System.out.println(String.valueOf(b)+1004); //무조건 문자열로 형변환
		System.out.println();
		...
		String str2=str1.replace("K", "L"); //K->L로 바꿈 (문자)
		System.out.println("name2 : "+str2);
		String str3=str1.replace("Kim", "Lee"); //kim를 lee로 바꾼다 (문자열)
